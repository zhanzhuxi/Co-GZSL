...
class CLASSIFIER:
    def __init__(self, _train_X, _train_Y, map_net, embed_size, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5,
    ...
    def fit(self):
        ...
        for epoch in range(self.nepoch):
            ...
            if H > best_H:
                ...
                #
                if H > self.H_best:
                    torch.save(self.model.state_dict(), './models/' + 'flo_softmax_model_weights_best.pth')
                    self.H_best = H
                #
